-- ============================================================
-- MIGRATION: Remove Manager WA from Perca Take Batch
-- Date: 2026-05-03
--
-- Tujuan:
-- Menghapus pengiriman notifikasi pengambilan perca ke manajer, 
-- sehingga sistem hanya akan mengirimkan 1 pesan (batched) kepada penjahit.
-- ============================================================
